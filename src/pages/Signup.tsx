      ...
      <div className="flex-1 flex flex-col justify-center px-8 lg:px-24 py-20 bg-white/80 lg:bg-white border-r border-stone-200 relative z-10 backdrop-blur-sm lg:backdrop-blur-0">
        ...
        >
          ...
          <nav className="flex gap-8 mb-12 border-b border-stone-100 pb-4">
            <Link to="/login" className="text-sm font-sans font-bold uppercase tracking-widest text-stone-400 hover:text-slate-primary transition-colors">Login</Link>
            <Link to="/signup" className="text-sm font-sans font-bold uppercase tracking-widest text-slate-primary border-b-2 border-slate-primary pb-4 -mb-[18px]">Register</Link>
          </nav>
          ...
          <p className="text-xl text-stone-500 font-sans leading-relaxed mb-16">
            Create your account today to access personalized services, community support, and professional care resources designed specifically for your needs.
          </p>
      ...
      <div className="hidden lg:flex flex-1 bg-stone-100 relative overflow-hidden">
        ...
        <div className="absolute bottom-12 left-12 right-12 p-8 bg-white/90 backdrop-blur-md border border-white/20 rounded-xl shadow-2xl">
          <p className="text-xl font-serif italic text-slate-primary leading-relaxed">
            "Belonging is a fundamental human need. We build the bridges that bring us together."
          </p>
          <div className="mt-6 flex items-center gap-4">
            <div className="w-12 h-12 rounded-full bg-terracotta/20" />
            <div>
              <p className="font-bold text-slate-primary">Sarah Jenkins</p>
              <p className="text-sm text-stone-500 uppercase tracking-widest">Community Director</p>
            </div>
          </div>
        </div>
      </div>
